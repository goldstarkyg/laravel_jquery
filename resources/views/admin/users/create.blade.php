                ...
                <div class="form-group user-roles">
                    <div class="input-group">
                        <select ng-model="vm.user.user_roles.role" ng-init="vm.user.user_roles.role = 'Role'">
                            ...
                            {{--<option value="4" ng-if="vm.authUser.user_roles.role > 3">Owner</option>--}}
                            {{--<option value="5" ng-if="vm.authUser.user_roles.role > 3">Client</option>--}}
                            {{--<option value="6" ng-if="vm.authUser.user_roles.role > 3">Advisor</option>--}}
                        </select>
                    </div>
                </div>
