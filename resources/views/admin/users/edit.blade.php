                ...
                <div class="form-group user-roles">
                    <div class="input-group">
                        <select ng-model="vm.user.user_roles.role">
                            ...
                            <option value="2" ng-selected="vm.user.user_roles.role === 2">Admin</option>
                            <option value="3" ng-selected="vm.user.user_roles.role === 3">Super Admin</option>
                            <option value="4" ng-selected="vm.user.user_roles.role === 4">Owner</option>
                            <option value="5" ng-selected="vm.user.user_roles.role === 5">Client</option>
                            <option value="6" ng-selected="vm.user.user_roles.role === 6">Advisor</option>
                            ...
                            {{--<option value="4" ng-selected="vm.user.user_roles.role === 4" ng-if="vm.authUser.user_roles.role > 3">Owner</option>--}}
                            {{--<option value="5" ng-selected="vm.user.user_roles.role === 5" ng-if="vm.authUser.user_roles.role > 3">Client</option>--}}
                            {{--<option value="6" ng-selected="vm.user.user_roles.role === 6" ng-if="vm.authUser.user_roles.role > 3">Advisor</option>--}}
                        </select>
                    </div>
                </div>
